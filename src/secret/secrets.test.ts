...
test('secrets', async () => {
  secretsDecrypt([secretDir], undefined, SECRET_ENCRYPTION_KEY)
  secretsDecrypt([secretDir], undefined, SECRET_ENCRYPTION_KEY, true)

  secretsEncrypt([secretDir], undefined, SECRET_ENCRYPTION_KEY)
  secretsEncrypt([secretDir], undefined, SECRET_ENCRYPTION_KEY, true)
})
